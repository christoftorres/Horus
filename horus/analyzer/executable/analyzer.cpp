...
struct t_btree_9__1_2_3_7_8__2_8_1_3_4_5_0_6_7__260__262__318__398__511 {
using t_tuple = Tuple<RamDomain, 9>;
Table<t_tuple> dataTable;
Lock insert_lock;
using t_ind_0 = btree_multiset<const t_tuple*, index_utils::deref_compare<typename index_utils::comparator<1,2,3,7,8>>>;
t_ind_0 ind_0;
using t_ind_1 = btree_set<const t_tuple*, index_utils::deref_compare<typename index_utils::comparator<2,8,1,3,4,5,0,6,7>>>;
t_ind_1 ind_1;
...
range<iterator_1> equalRange_318(const t_tuple& t, context& h) const {
t_tuple low(t); t_tuple high(t);
low[0] = MIN_RAM_DOMAIN;
high[0] = MAX_RAM_DOMAIN;
low[6] = MIN_RAM_DOMAIN;
...
range<iterator_1> equalRange_318(const t_tuple& t) const {
context h; return equalRange_318(t, h);
}
range<iterator_0> equalRange_398(const t_tuple& t, context& h) const {
t_tuple low(t); t_tuple high(t);
low[0] = MIN_RAM_DOMAIN;
high[0] = MAX_RAM_DOMAIN;
low[4] = MIN_RAM_DOMAIN;
...
range<iterator_0> equalRange_398(const t_tuple& t) const {
...
void printHintStatistics(std::ostream& o, const std::string prefix) const {
const auto& stats_0 = ind_0.getHintStatistics();
o << prefix << "arity 9 indirect b-tree index [1,2,3,7,8]: (hits/misses/total)\n";
o << prefix << "Insert: " << stats_0.inserts.getHits() << "/" << stats_0.inserts.getMisses() << "/" << stats_0.inserts.getAccesses() << "\n";
o << prefix << "Contains: " << stats_0.contains.getHits() << "/" << stats_0.contains.getMisses() << "/" << stats_0.contains.getAccesses() << "\n";
o << prefix << "Lower-bound: " << stats_0.lower_bound.getHits() << "/" << stats_0.lower_bound.getMisses() << "/" << stats_0.lower_bound.getAccesses() << "\n";
o << prefix << "Upper-bound: " << stats_0.upper_bound.getHits() << "/" << stats_0.upper_bound.getMisses() << "/" << stats_0.upper_bound.getAccesses() << "\n";
...
struct t_btree_6__1_5_0_2_3_4__2__34__63 {
using t_tuple = Tuple<RamDomain, 6>;
...
void insertAll(t_btree_6__1_5_0_2_3_4__2__34__63& other) {
ind_0.insertAll(other.ind_0);
}
bool contains(const t_tuple& t, context& h) const {
return ind_0.contains(t, h.hints_0);
...
// -- Table: call
std::unique_ptr<t_btree_9__1_2_3_7_8__2_8_1_3_4_5_0_6_7__260__262__318__398__511> rel_2_call = std::make_unique<t_btree_9__1_2_3_7_8__2_8_1_3_4_5_0_6_7__260__262__318__398__511>();
souffle::RelationWrapper<1,t_btree_9__1_2_3_7_8__2_8_1_3_4_5_0_6_7__260__262__318__398__511,Tuple<RamDomain,9>,9,1> wrapper_rel_2_call;
// -- Table: throw
...
// -- Table: transfer
std::unique_ptr<t_btree_6__1_5_0_2_3_4__2__34__63> rel_15_transfer = std::make_unique<t_btree_6__1_5_0_2_3_4__2__34__63>();
souffle::RelationWrapper<12,t_btree_6__1_5_0_2_3_4__2__34__63,Tuple<RamDomain,6>,6,1> wrapper_rel_15_transfer;
...
// -- Table: ShortAddress
std::unique_ptr<t_btree_8__0_1_2_3_4_5_6_7__255> rel_17_ShortAddress = std::make_unique<t_btree_8__0_1_2_3_4_5_6_7__255>();
souffle::RelationWrapper<14,t_btree_8__0_1_2_3_4_5_6_7__255,Tuple<RamDomain,8>,8,1> wrapper_rel_17_ShortAddress;
// -- Table: selfdestruct
std::unique_ptr<t_btree_6__1_0_2_3_4_5__2__63> rel_18_selfdestruct = std::make_unique<t_btree_6__1_0_2_3_4_5__2__63>();
souffle::RelationWrapper<15,t_btree_6__1_0_2_3_4_5__2__63,Tuple<RamDomain,6>,6,1> wrapper_rel_18_selfdestruct;
// -- Table: ParityWalletHack2
std::unique_ptr<t_btree_8__0_1_2_3_4_5_6_7__255> rel_19_ParityWalletHack2 = std::make_unique<t_btree_8__0_1_2_3_4_5_6_7__255>();
souffle::RelationWrapper<16,t_btree_8__0_1_2_3_4_5_6_7__255,Tuple<RamDomain,8>,8,1> wrapper_rel_19_ParityWalletHack2;
// -- Table: condition
std::unique_ptr<t_btree_2__0_1__3> rel_20_condition = std::make_unique<t_btree_2__0_1__3>();
souffle::RelationWrapper<17,t_btree_2__0_1__3,Tuple<RamDomain,2>,2,1> wrapper_rel_20_condition;
// -- Table: used_in_condition
std::unique_ptr<t_btree_2__0_1__3> rel_21_used_in_condition = std::make_unique<t_btree_2__0_1__3>();
souffle::RelationWrapper<18,t_btree_2__0_1__3,Tuple<RamDomain,2>,2,1> wrapper_rel_21_used_in_condition;
// -- Table: UnhandledException
std::unique_ptr<t_btree_7__0_1_2_3_4_5_6__127> rel_22_UnhandledException = std::make_unique<t_btree_7__0_1_2_3_4_5_6__127>();
souffle::RelationWrapper<19,t_btree_7__0_1_2_3_4_5_6__127,Tuple<RamDomain,7>,7,1> wrapper_rel_22_UnhandledException;
public:
Sf_analyzer() : 
...
wrapper_rel_17_ShortAddress(*rel_17_ShortAddress,symTable,"ShortAddress",std::array<const char *,8>{{"s:symbol","i:number","i:number","s:Address","s:Address","s:Address","s:Address","s:Value"}},std::array<const char *,8>{{"hash","timestamp","step","attacker","contract","from","to","amount"}}),

wrapper_rel_18_selfdestruct(*rel_18_selfdestruct,symTable,"selfdestruct",std::array<const char *,6>{{"i:number","s:symbol","s:Address","s:Address","s:Address","s:Value"}},std::array<const char *,6>{{"step","transaction_hash","caller","contract","destination","amount"}}),

wrapper_rel_19_ParityWalletHack2(*rel_19_ParityWalletHack2,symTable,"ParityWalletHack2",std::array<const char *,8>{{"s:symbol","s:symbol","i:number","i:number","s:Address","s:Address","s:Address","s:Value"}},std::array<const char *,8>{{"hash1","hash2","timestamp1","timestamp2","caller","contract","destination","amount"}}),

wrapper_rel_20_condition(*rel_20_condition,symTable,"condition",std::array<const char *,2>{{"i:number","s:symbol"}},std::array<const char *,2>{{"step","transaction_hash"}}),

wrapper_rel_21_used_in_condition(*rel_21_used_in_condition,symTable,"used_in_condition",std::array<const char *,2>{{"i:number","s:symbol"}},std::array<const char *,2>{{"step","hash"}}),

wrapper_rel_22_UnhandledException(*rel_22_UnhandledException,symTable,"UnhandledException",std::array<const char *,7>{{"s:symbol","i:number","i:number","s:Address","s:Address","s:Address","s:Value"}},std::array<const char *,7>{{"hash","timestamp","step","attacker","caller","callee","amount"}}){
...
addRelation("ShortAddress",&wrapper_rel_17_ShortAddress,false,true);
addRelation("selfdestruct",&wrapper_rel_18_selfdestruct,true,false);
addRelation("ParityWalletHack2",&wrapper_rel_19_ParityWalletHack2,false,true);
addRelation("condition",&wrapper_rel_20_condition,true,false);
addRelation("used_in_condition",&wrapper_rel_21_used_in_condition,false,false);
...
for(const auto& env0 : range) {
if( ((symTable.lookup(substr_wrapper(symTable.resolve(env0[5]),(RamDomain(0)),(RamDomain(8))))) == (RamDomain(7)))) {
...
for(const auto& env1 : range) {
if( ((symTable.lookup(substr_wrapper(symTable.resolve(env1[5]),(RamDomain(0)),(RamDomain(8))))) == (RamDomain(8))) && ((env0[2]) < (env1[2]))) {
const Tuple<RamDomain,9> key{{0,env1[0],RamDomain(2),0,0,0,0,0,RamDomain(1)}};
...
for(const auto& env1 : range) {
if( ((symTable.lookup(substr_wrapper(symTable.resolve(env1[5]),(RamDomain(0)),(RamDomain(8))))) == (RamDomain(8))) && ((env0[1]) < (env1[1]))) {
const Tuple<RamDomain,9> key{{0,env1[0],RamDomain(2),0,0,0,0,0,RamDomain(1)}};
auto range = rel_2_call->equalRange_262(key,READ_OP_CONTEXT(rel_2_call_op_ctxt));
for(const auto& env2 : range) {
const Tuple<RamDomain,4> key{{env0[2],0,0,0}};
...
SignalHandler::instance()->setMsg(R"_(Reentrancy(hash,timestamp,step3,attacker,caller,callee,depth2,amount) :- 
   ...
   call(step3,hash,"CALL",caller,callee,input_data,amount,depth2,1),
...
for(const auto& env0 : range) {
const Tuple<RamDomain,9> key{{0,env0[2],RamDomain(2),env0[4],0,0,0,env0[7],RamDomain(1)}};
auto range = rel_2_call->equalRange_398(key,READ_OP_CONTEXT(rel_2_call_op_ctxt));
for(const auto& env1 : range) {
if( ((env0[0]) < (env1[0]))) {
const Tuple<RamDomain,9> key{{0,env0[2],RamDomain(2),env0[4],env1[4],env1[5],0,0,RamDomain(1)}};
auto range = rel_2_call->equalRange_318(key,READ_OP_CONTEXT(rel_2_call_op_ctxt));
for(const auto& env2 : range) {
if( ((env0[7]) < (env2[7]))) {
const Tuple<RamDomain,8> key{{0,RamDomain(3),env0[2],0,env0[4],env0[5],0,env0[7]}};
...
const Tuple<RamDomain,8> key{{0,RamDomain(3),0,0,0,0,0,0}};
auto range = rel_13_storage->equalRange_2(key,READ_OP_CONTEXT(rel_13_storage_op_ctxt));
for(const auto& env2 : range) {
...
CREATE_OP_CONTEXT(rel_4_transaction_op_ctxt,rel_4_transaction->createContext());
CREATE_OP_CONTEXT(rel_1_block_op_ctxt,rel_1_block->createContext());
CREATE_OP_CONTEXT(rel_17_ShortAddress_op_ctxt,rel_17_ShortAddress->createContext());
CREATE_OP_CONTEXT(rel_15_transfer_op_ctxt,rel_15_transfer->createContext());
const Tuple<RamDomain,9> key{{0,0,0,0,0,0,0,0,RamDomain(1)}};
auto range = rel_4_transaction->equalRange_256(key,READ_OP_CONTEXT(rel_4_transaction_op_ctxt));
for(const auto& env0 : range) {
if( ((symTable.lookup(substr_wrapper(symTable.resolve(env0[5]),(RamDomain(0)),(RamDomain(8))))) == (RamDomain(10))) && (((static_cast<RamDomain>(symTable.resolve(env0[5]).size())) / (RamDomain(2))) < (RamDomain(68)))) {
...
rel_17_ShortAddress->insert(tuple,READ_OP_CONTEXT(rel_17_ShortAddress_op_ctxt));
}
}
}
}
...
auto range = rel_4_transaction->equalRange_256(key,READ_OP_CONTEXT(rel_4_transaction_op_ctxt));
for(const auto& env0 : range) {
if( ((symTable.lookup(substr_wrapper(symTable.resolve(env0[5]),(RamDomain(0)),(RamDomain(8))))) == (RamDomain(11))) && (((static_cast<RamDomain>(symTable.resolve(env0[5]).size())) / (RamDomain(2))) < (RamDomain(100)))) {
const Tuple<RamDomain,6> key{{0,env0[0],0,0,0,0}};
auto range = rel_15_transfer->equalRange_2(key,READ_OP_CONTEXT(rel_15_transfer_op_ctxt));
for(const auto& env1 : range) {
const Tuple<RamDomain,4> key{{env0[2],0,0,0}};
...
if (!outputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = outputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
IOSystem::getInstance().getWriter(std::vector<bool>({1,0,0,1,1,1,1,1}), symTable, ioDirectives, false, 1)->writeAll(*rel_17_ShortAddress);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
}
...
if (!inputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = inputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
IOSystem::getInstance().getReader(std::vector<bool>({0,1,1,1,1,1}), symTable, ioDirectives, false, 1)->readAll(*rel_18_selfdestruct);
} catch (std::exception& e) {std::cerr << "Error loading data: " << e.what() << '\n';}
}
}();
/* END STRATUM 15 */
...
if(!(rel_4_transaction->empty()) && !(rel_18_selfdestruct->empty()) && !(rel_1_block->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_4_transaction_op_ctxt,rel_4_transaction->createContext());
CREATE_OP_CONTEXT(rel_1_block_op_ctxt,rel_1_block->createContext());
CREATE_OP_CONTEXT(rel_19_ParityWalletHack2_op_ctxt,rel_19_ParityWalletHack2->createContext());
CREATE_OP_CONTEXT(rel_18_selfdestruct_op_ctxt,rel_18_selfdestruct->createContext());
const Tuple<RamDomain,9> key{{0,0,0,0,0,0,0,0,RamDomain(1)}};
auto range = rel_4_transaction->equalRange_256(key,READ_OP_CONTEXT(rel_4_transaction_op_ctxt));
for(const auto& env0 : range) {
if( ((symTable.lookup(substr_wrapper(symTable.resolve(env0[5]),(RamDomain(0)),(RamDomain(8))))) == (RamDomain(7)))) {
...
auto range = rel_4_transaction->equalRange_280(key,READ_OP_CONTEXT(rel_4_transaction_op_ctxt));
for(const auto& env1 : range) {
if( ((symTable.lookup(substr_wrapper(symTable.resolve(env1[5]),(RamDomain(0)),(RamDomain(8))))) == (RamDomain(9))) && ((env0[2]) < (env1[2]))) {
const Tuple<RamDomain,6> key{{0,env1[0],0,0,0,0}};
auto range = rel_18_selfdestruct->equalRange_2(key,READ_OP_CONTEXT(rel_18_selfdestruct_op_ctxt));
for(const auto& env2 : range) {
const Tuple<RamDomain,4> key{{env0[2],0,0,0}};
auto range = rel_1_block->equalRange_1(key,READ_OP_CONTEXT(rel_1_block_op_ctxt));
for(const auto& env3 : range) {
...
rel_19_ParityWalletHack2->insert(tuple,READ_OP_CONTEXT(rel_19_ParityWalletHack2_op_ctxt));
}
}
}
}
...
auto range = rel_4_transaction->equalRange_284(key,READ_OP_CONTEXT(rel_4_transaction_op_ctxt));
for(const auto& env1 : range) {
if( ((symTable.lookup(substr_wrapper(symTable.resolve(env1[5]),(RamDomain(0)),(RamDomain(8))))) == (RamDomain(9))) && ((env0[1]) < (env1[1]))) {
const Tuple<RamDomain,6> key{{0,env1[0],0,0,0,0}};
auto range = rel_18_selfdestruct->equalRange_2(key,READ_OP_CONTEXT(rel_18_selfdestruct_op_ctxt));
for(const auto& env2 : range) {
const Tuple<RamDomain,4> key{{env0[2],0,0,0}};
...
if (!outputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = outputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
IOSystem::getInstance().getWriter(std::vector<bool>({1,1,0,0,1,1,1,1}), symTable, ioDirectives, false, 1)->writeAll(*rel_19_ParityWalletHack2);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
}
if (!isHintsProfilingEnabled()&& performIO) rel_18_selfdestruct->purge();
}();
/* END STRATUM 16 */
/* BEGIN STRATUM 17 */
[&]() {
...
if (!inputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = inputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
IOSystem::getInstance().getReader(std::vector<bool>({0,1}), symTable, ioDirectives, false, 1)->readAll(*rel_20_condition);
} catch (std::exception& e) {std::cerr << "Error loading data: " << e.what() << '\n';}
}
}();
/* END STRATUM 17 */
...
if(!(rel_9_data_flow->empty()) && !(rel_20_condition->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_9_data_flow_op_ctxt,rel_9_data_flow->createContext());
CREATE_OP_CONTEXT(rel_21_used_in_condition_op_ctxt,rel_21_used_in_condition->createContext());
CREATE_OP_CONTEXT(rel_20_condition_op_ctxt,rel_20_condition->createContext());
for(const auto& env0 : *rel_20_condition) {
...
rel_21_used_in_condition->insert(tuple,READ_OP_CONTEXT(rel_21_used_in_condition_op_ctxt));
}
}
}
();}
if (!isHintsProfilingEnabled()&& performIO) rel_20_condition->purge();
...
auto range = rel_2_call->equalRange_260(key,READ_OP_CONTEXT(rel_2_call_op_ctxt));
for(const auto& env0 : range) {
if( !(rel_21_used_in_condition->contains(Tuple<RamDomain,2>{{env0[0],env0[1]}},READ_OP_CONTEXT(rel_21_used_in_condition_op_ctxt))) && !regex_wrapper(symTable.resolve(RamDomain(4)),symTable.resolve(env0[6]))) {
...
if (!outputDirectory.empty() && directiveMap["IO"] == "file" && directiveMap["filename"].front() != '/') {directiveMap["filename"] = outputDirectory + "/" + directiveMap["filename"];}
IODirectives ioDirectives(directiveMap);
IOSystem::getInstance().getWriter(std::vector<bool>({1,0,0,1,1,1,1}), symTable, ioDirectives, false, 1)->writeAll(*rel_22_UnhandledException);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
}
...
if (!isHintsProfilingEnabled()&& performIO) rel_21_used_in_condition->purge();
}();
/* END STRATUM 19 */
...
std::cout << "\n";
std::cout << "Relation rel_17_ShortAddress:\n";
rel_17_ShortAddress->printHintStatistics(std::cout,"  ");
std::cout << "\n";
std::cout << "Relation rel_18_selfdestruct:\n";
rel_18_selfdestruct->printHintStatistics(std::cout,"  ");
std::cout << "\n";
std::cout << "Relation rel_19_ParityWalletHack2:\n";
rel_19_ParityWalletHack2->printHintStatistics(std::cout,"  ");
std::cout << "\n";
std::cout << "Relation rel_20_condition:\n";
rel_20_condition->printHintStatistics(std::cout,"  ");
std::cout << "\n";
std::cout << "Relation rel_21_used_in_condition:\n";
rel_21_used_in_condition->printHintStatistics(std::cout,"  ");
std::cout << "\n";
...
try {IODirectives ioDirectives;
ioDirectives.setIOType("stdout");
ioDirectives.setRelationName("rel_18_selfdestruct");
IOSystem::getInstance().getWriter(std::vector<bool>({0,1,1,1,1,1}), symTable, ioDirectives, false, 1)->writeAll(*rel_18_selfdestruct);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
try {IODirectives ioDirectives;
ioDirectives.setIOType("stdout");
ioDirectives.setRelationName("rel_20_condition");
IOSystem::getInstance().getWriter(std::vector<bool>({0,1}), symTable, ioDirectives, false, 1)->writeAll(*rel_20_condition);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
}
public:
...
try {IODirectives ioDirectives;
ioDirectives.setIOType("stdout");
ioDirectives.setRelationName("rel_17_ShortAddress");
IOSystem::getInstance().getWriter(std::vector<bool>({1,0,0,1,1,1,1,1}), symTable, ioDirectives, false, 1)->writeAll(*rel_17_ShortAddress);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
try {IODirectives ioDirectives;
ioDirectives.setIOType("stdout");
ioDirectives.setRelationName("rel_19_ParityWalletHack2");
IOSystem::getInstance().getWriter(std::vector<bool>({1,1,0,0,1,1,1,1}), symTable, ioDirectives, false, 1)->writeAll(*rel_19_ParityWalletHack2);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
try {IODirectives ioDirectives;
ioDirectives.setIOType("stdout");
