...
class Etherscan():
    ...
    def get_normal_transactions(self, address, start_block=0, end_block=99999999, offset=1000):
    ...
    def get_internal_transactions(self, address, start_block=0, end_block=99999999, offset=1000):
    ...
    def get_token_transactions(self, address, start_block=0, end_block=99999999, offset=1000):
