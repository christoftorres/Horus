...
#SBATCH -J Horus_24        # Set the job name
...
cat $HOME/Horus/arguments/parallel_launcher_arguments_24 | $parallel "python3 horus.py -c {} -l /work/projects/horus/contracts/{}.json -r ../new_results"
