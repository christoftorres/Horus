...
#SBATCH -J Horus_10        # Set the job name
...
cat $HOME/Horus/arguments/parallel_launcher_arguments_10 | $parallel "python3 horus.py -c {} -l /work/projects/horus/contracts/{}.json -r ../new_results"
